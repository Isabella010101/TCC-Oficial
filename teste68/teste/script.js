...
// ===================================
// 🚀 6. LÓGICA DE INICIALIZAÇÃO DO JOGO
// ===================================
...
// ===================================================================
// 🔐 7. LÓGICA DE MODAIS DE AUTENTICAÇÃO E FETCH (AJAX)
// ===================================================================
...
// ----------------------------------------------------
// LÓGICA DE ENVIO DO FORMULÁRIO (COM RELOAD)
// ----------------------------------------------------
        ...
        if (result.success) {
            ...
            if (form.id === 'form-login') {
                setTimeout(() => {
                    ...
                    // RECARREGA A PÁGINA PARA ATIVAR A SESSÃO E A CUTSCENE
...
// ===================================
// 📒 8. LÓGICA DO CARROSSEL DE RECEITAS
// ===================================
...
// ===================================
// 🎬 9. LÓGICA DA CUT SCENE (INTRODUÇÃO)
// ===================================
...
// ===================================
// 🎯 10. ABERTURA INTELIGENTE (MAIN)
// ===================================
window.onload = function() {
    console.log("🖥️ Página carregada.");

    // Verifica se o usuário está logado (variável vem do PHP no HTML)
    if (typeof usuarioEstaLogado !== 'undefined' && usuarioEstaLogado === true) {
        
        console.log("✅ Usuário logado! Abrindo Cut Scene...");
        
        // 1. Esconde os modais de início e login
        if (modalInicio) modalInicio.style.display = 'none';
        if (modalLoginCadastro) modalLoginCadastro.style.display = 'none';

        // 2. Abre a Cut Scene (A História)
        if (modalCutscene) {
            modalCutscene.style.display = 'flex'; 
        } else {
            // Fallback: Se não achar a cutscene, inicia o jogo direto
            iniciarLogicaDoJogo();
        }
        ...
        // Se não tá logado, mostra o modal de Início
        if (modalInicio) {
